...
namespace T2_RevillaFernandezHectorRolando.Controllers
{
    public class VentasController : Controller
    {
        private readonly T2_RevillaFernandezHectorRolandoContext _context;

        public VentasController(T2_RevillaFernandezHectorRolandoContext context)
        {
            _context = context;
        }
